...
class RealTimePlotWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, port, config, status_queue):
        ...
        pre_test_notes = [
            ...
            ["sensor calibration (k d c)", f'{self.k_A1} {self.k_B1} {self.k_A2} {self.k_B2}', f'{self.d_A1} {self.d_B1} {self.d_A2} {self.d_B2}', f'{self.c_A1} {self.c_B1} {self.c_A2} {self.c_B2}', '', ''],

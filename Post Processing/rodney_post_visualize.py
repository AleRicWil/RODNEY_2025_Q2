...
csv_path = r'Calibration\Current Calibration\06_05_test_20.csv'
...
strain_ax_smooth = savgol_filter(strain_ax, 30, 2)
strain_bx_smooth = savgol_filter(strain_bx, 30, 2)
strain_ay_smooth = savgol_filter(strain_ay, 30, 2)
strain_by_smooth = savgol_filter(strain_by, 30, 2)
...
plt.plot(time_sec, force_x)
plt.plot(time_sec, force_y)

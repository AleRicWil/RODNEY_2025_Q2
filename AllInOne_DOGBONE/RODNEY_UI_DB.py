...
class HardwareControlUI:
    ...
    def load_summary_csv(self):
        ...
        try:
            with open(file_path, 'r', newline='') as csvfile:
                ...
                if headers != ['Mass (g)', 'Position (cm)', 'Avg Strain 1', 'Avg Strain 11', 'Avg Strain 2', 'Avg Strain 3']:
    ...
    def calculate_coefficients(self):
        ...
        parent_folder = 'AllInOne_DOGBONE'
        ...
        row = [
            ...
            coeff_data['1']['k'], coeff_data['11']['k'], coeff_data['2']['k'], coeff_data['3']['k'],
            coeff_data['1']['d'], coeff_data['11']['d'], coeff_data['2']['d'], coeff_data['3']['d'],
            coeff_data['1']['c'], coeff_data['11']['c'], coeff_data['2']['c'], coeff_data['3']['c']
        ]
        ...
        with open(csv_path, 'a', newline='') as csvfile:
            ...
            if not file_exists:
                headers = ['Date', 'k_1', 'k_11', 'k_2', 'k_3', 'd_1', 'd_11', 'd_2', 'd_3', 'c_1', 'c_11', 'c_2', 'c_3']
